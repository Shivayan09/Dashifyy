  ...
  return (
    <div className='px-5 md:px-10 pt-5 min-h-full'>
      ...
      <div className="add py-5 flex flex-col md:flex-row gap-3 md:gap-5 mb-5 md:mb-0">
        <input type="text" placeholder='Subject name' className='h-10 w-full relative z-10 bg-white text-purple-900 md:w-[30%] border border-purple-700/50 shadow-md rounded-xl p-3 outline-none'
          onChange={(e) => setName(e.target.value)} />
        <input type="text" placeholder='Subject code' className='h-10 w-full relative z-10 bg-white text-purple-900 md:w-[30%] border border-purple-700/50 shadow-md rounded-xl p-3 outline-none'
          onChange={(e) => setCode(e.target.value)} />
        <input type="number" placeholder='Subject credit' className='h-10 w-full relative z-10 bg-white text-purple-900 md:w-[30%] border border-purple-700/50 shadow-md rounded-xl p-3 outline-none'
          onChange={(e) => setCredit(e.target.value)} />
        <button className='text-purple-900 bg-purple-100 transition-all mx-auto md:mx-0 hover:shadow-md flex items-center justify-center border border-purple-800 h-10 w-full md:w-10 rounded-xl cursor-pointer'
      ...
      <div className="display">
        <div className="box w-full flex flex-col gap-5 md:gap-5 h-[70vh] md:overflow-y-auto pr-3">
